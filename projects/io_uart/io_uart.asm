; ================================================================================
; IO_UART.ASM - b8008 UART Echo Demo
; ================================================================================
; Prints "Hello 8008 > " prompt, then echoes user input character by character.
;
; I/O Ports:
...
; ================================================================================
; SEND_PROMPT - Send "Hello 8008 > " followed by nothing (cursor stays on line)
; ================================================================================
send_prompt:
